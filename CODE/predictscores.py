...
def feature(xnewclean,xtestnewclean):
...
def predictposneg(xt_vec):
    filename = 'finalized_model.sav'
    loaded_model = pickle.load(open(filename, 'rb'))
    result = loaded_model.predict(xt_vec)
    return result

def generatelabels(x_test):
    ...
    xt_vec = feature(xnewclean,xtestnewclean)

    y_pred = predictposneg(xt_vec)
    return y_pred
